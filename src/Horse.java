public class Horse extends ChessPiece {
    ...
    public boolean canMoveToPosition(ChessBoard chessBoard, int line, int column, int toLine, int toColumn) {
        return super.movesInBoundaries(toLine, toColumn) && correctHorseMove(line, column, toLine, toColumn) && isMovingWithoutCollision(chessBoard, line, column, toLine, toColumn);
    }
